...
async function run() {
  ...
  console.log('sawtooth-precompute start');
  ...
  try {
    ...
    console.log('sawtooth-precompute gtl_rows=' + rawRows.length + ' parsed=' + rows.length + ' deduped=' + gtlList.length + ' skipped_no_anchor=' + skippedNoAnchor + ' emitted=' + points.length);
    ...
    console.log('sawtooth-precompute pushed minutes=' + points.length);
  } catch (err) {
